...
(* OASIS_START *)
(* DO NOT EDIT (digest: fa8cbea704cfcd596a8ee869d8bd0e9c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://modlfo.github.io/vult/";
          synopsis =
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build the code to convert to js";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Error"; "Loc"; "PrintBuffer"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/generators/templates";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("pla", None);
                           FindlibPackage ("pla.ppx", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Templates"; "Pd"; "TeensyAudio"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/generators";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "vult_core";
                           InternalLibrary "vult_util";
                           InternalLibrary "vult_passes";
                           InternalLibrary "vult_templates";
                           FindlibPackage ("ppx_deriving.std", None);
                           FindlibPackage ("containers", None);
                           FindlibPackage ("pla", None);
                           FindlibPackage ("pla.ppx", None);
                           FindlibPackage ("llvm", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "vult_core";
                           InternalLibrary "vult_parser";
                           InternalLibrary "vult_util";
                           InternalLibrary "vult_generators";
                           InternalLibrary "vult_passes";
                           FindlibPackage ("containers", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "vultc.ml"});
               Executable
                 ({
                     cs_name = "vultdebug";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, ["-custom"])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {exec_custom = false; exec_main_is = "vultc.ml"});
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "vult_node.ml"});
               Executable
                 ({
                     cs_name = "vult_tests";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Vult";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/modlfo/vult.git";
                      src_repo_browser =
                        Some "https://github.com/modlfo/vult";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\012/x\155ýk\159bÐq­)\149ecÝ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
